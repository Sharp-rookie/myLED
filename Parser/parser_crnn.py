...
def getCRNNParser(parser):
    ...
    parser.add_argument("--output_forecasting_loss",
                        help="loss of RNN forecasting (if 0, autoencoder mode)",
                        type=int,
                        default=1,
                        required=False)

    parser.add_argument("--latent_forecasting_loss",
    ...
    parser.add_argument("--n_warmup_train",
                        help="n_warmup_train",
                        type=int,
                        required=False,
                        default=0)
    ...
    parser.add_argument("--buffer_train_time",
    ...
    parser.add_argument("--iterative_propagation_during_training_is_latent",
                        help="Unplug the encoder and propagate only the latent state during iterative forecasting (only used for training).",
                        type=int,
                        default=0,
                        required=False)
    ...
    parser.add_argument("--hvd_compression",
                        help="Horovod compression algorithm [fp16 or none]",
                        type=int,
                        required=False,
                        default=0)

    parser.add_argument("--hvd_adasum",
                        help="whether to use AdaSum or not",
                        type=int,
                        required=False,
                        default=0)

    parser.add_argument("--beta_vae",
                        help="Beta variational layer in the latent space.",
                        type=int,
                        required=False,
                        default=0)
    parser.add_argument("--beta_vae_weight_max",
                        help="Weight of Beta-VAE (max towards end of training)",
                        type=float,
                        required=False,
                        default=0.0)

    parser.add_argument("--c1_latent_smoothness_loss",
                        help="c1_latent_smoothness_loss",
                        type=int,
                        required=False,
                        default=0)
    parser.add_argument("--c1_latent_smoothness_loss_factor",
                        help="c1_latent_smoothness_loss_factor",
                        type=float,
                        required=False,
                        default=0.0)
    parser.add_argument("--latent_space_scaler",
