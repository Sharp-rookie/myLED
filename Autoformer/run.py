...
def main():
    ...
    # data loader
    parser.add_argument('--data', type=str, required=False, default='JCP_5.0', help='dataset type')
    parser.add_argument('--root_path', type=str, default='./data/JCP/', help='root path of the data file')
    parser.add_argument('--data_path', type=str, default='tau_5.0.csv', help='data file')
