...
class TCN(nn.Module):
    def __init__(self, input_size, output_size, num_channels, kernel_size, dropout, data_dim):
        ...
        self.register_buffer('min', torch.zeros(1, data_dim, dtype=torch.float32))
        self.register_buffer('max', torch.ones(1, data_dim, dtype=torch.float32))
