...
def test_and_save_embeddings_of_time_lagged(
    ...
    for ep in [max_epoch]:
        ...
        print(f'\rTau[{tau}] | Test epoch[{epoch}/{max_epoch}] | MLE={MLE_id:.1f}, DANCo={DANCo_id:.1f}, MiND_ML={MiND_id:.1f}', end='')
        ...
        #     fp.write(f"{tau},{random_seed},{mse_[0]},{mse_[1]},{epoch},{MLE_id}\n")
        # elif 'PNAS17' in system:
        #     fp.write(f"{tau},{random_seed},{mse_[0]},{mse_[0+obs_dim]},{epoch},{MLE_id},{MiND_id},{MADA_id},{PCA_id}\n")
        # fp.flush()
