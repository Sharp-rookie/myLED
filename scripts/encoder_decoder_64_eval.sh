...
#                                           exec sh";
screen -S eval-"$dataset"-64 -dm bash -c "CUDA_VISIBLE_DEVICES="$gpu" python ../eval.py ../configs/"$dataset"/model64/config1.yaml ../logs/logs_"$dataset"_encoder-decoder-64_1/lightning_logs/checkpoints NA eval-eval NA; \
                                          exec sh";