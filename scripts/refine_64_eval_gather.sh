...
#                                                  exec sh";
screen -S eval-"$dataset"-refine-64 -dm bash -c "CUDA_VISIBLE_DEVICES="$gpu" python ../eval.py ../configs/"$dataset"/refine64/config1.yaml ../logs/logs_"$dataset"_refine-64_1/lightning_logs/checkpoints ../logs/logs_"$dataset"_encoder-decoder-64_1/lightning_logs/checkpoints eval-refine-train NA; \
                                                 exec sh";