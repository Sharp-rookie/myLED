...
#                                         exec sh";
screen -S train-"$dataset" -dm bash -c "CUDA_VISIBLE_DEVICES="$gpu" python ../main.py latentpred ../configs/"$dataset"/latentpred/config1.yaml ../logs/logs_"$dataset"_encoder-decoder-64_1/lightning_logs/checkpoints/ ../logs/logs_"$dataset"_refine-64_1/lightning_logs/checkpoints/; \
                                        exec sh";